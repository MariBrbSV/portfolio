...
class CardStreamController {
  ...
  calculateCodeDimensions(cardWidth, cardHeight) {
    ...
    const lineHeight = isMobile ? 10 : 13;
    const charWidth = isMobile ? 5 : 6;
  ...
  createCardWrapper(index) {
    ...
    const cardHeight = isMobile ? 170 : 250;

    const normalCard = document.createElement("div");
    normalCard.className = "card card-normal";

    // URLs das suas imagens de projetos - ALTERE AQUI
    const cardImages = [
      "../img/card-1.png",
      "../img/card-2.png",
      "../img/card-3.png",
    ...
    cardImage.alt = "Projeto Portfolio";
    ...
    const { width, height, fontSize, lineHeight } = this.calculateCodeDimensions(cardWidth, cardHeight);
...
class ParticleSystem {
  ...
  createParticles() {
    ...
    gradient.addColorStop(0.1, "#0066ff");
    gradient.addColorStop(0.25, "#001a33");
...
class ParticleScanner {
  ...
  drawLightBar() {
    ...
    glow1Gradient.addColorStop(0, "rgba(0, 102, 255, 0)");
    glow1Gradient.addColorStop(0.5, `rgba(0, 212, 255, ${0.8 * glowIntensity})`);
    glow1Gradient.addColorStop(1, "rgba(0, 102, 255, 0)");
    ...
    glow2Gradient.addColorStop(0, "rgba(0, 102, 255, 0)");
    glow2Gradient.addColorStop(0.5, `rgba(0, 102, 255, ${0.4 * glowIntensity})`);
    glow2Gradient.addColorStop(1, "rgba(0, 102, 255, 0)");
    ...
    if (this.scanningActive) {
      ...
      glow3Gradient.addColorStop(0, "rgba(0, 102, 255, 0)");
      glow3Gradient.addColorStop(0.5, "rgba(0, 102, 255, 0.2)");
      glow3Gradient.addColorStop(1, "rgba(0, 102, 255, 0)");
